...
<body>
   ...
   <section class = "hero-wrap hero-wrap-2" style = "background-image: url('Imagenes/bg2.jpg);" data-stellar-background-ratio = "0.5">
        ...
        <div class = "container">
            <div class = "row justify-content-center pb-3">
                <div class = "col-md-10 heading-section text-center ftco-animate">
                    ...
                    <p> Tenemos un gran pull de servicios para tu deleite, sabemos que te encantarà disfrutar de nuestros Servicios </p>
                </div>
            </div>
